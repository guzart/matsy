...
const clearCacheRegexp = /matsy\/(?!node_modules)/;
function clearRequireCache() {
  debug('CLEAR CACHE', Object.keys(require.cache).filter(id => clearCacheRegexp.test(id)));
  Object.keys(require.cache)
    .filter(id => clearCacheRegexp.test(id))
